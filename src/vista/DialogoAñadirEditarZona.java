...
import controlador.ControladorAÒadirEditarZona;
import modelo.Casa;
import modelo.Zona;

public class DialogoAÒadirEditarZona extends JDialog {
	...
	MenuConfig vista;
	int i = 0;
	String tiposZona[] = { "BaÒo", "Sal√≥n", "Cocina", "Habitaci√≥n", "Jardin" };

	public DialogoAÒadirEditarZona(JFrame ventana, String titulo, boolean modo, boolean estaAÒadiendo, Casa casa) {
		super(ventana, titulo, modo);
		this.vista = (MenuConfig) ventana;
		this.casa = casa;
		controlador = new ControladorAÒadirEditarZona(this, vista.getCasa(), estaAÒadiendo);
